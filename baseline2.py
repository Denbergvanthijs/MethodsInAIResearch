...
names = ['ack', 'affirm', 'bye', 'confirm', 'deny', 'hello', 'inform',
         ...
         'restart', 'thankyou']
keys = [['kay', 'okay', 'okay ah', 'okay um', 'okay uh', 'im good',
       'fine', 'okay can you', 'thatll do'],
['yes', 'yea', 'right', 'yeah', 'correct'],
['goodbye', 'good bye', 'bye'],
['is it', 'is there', 'does it', 
           'okay and', 'is that', 'does that'],
['i dont', 'wrong', 'no i dont', 'not any more', 'no not', 
        'can you change', 'dont want', 'not'],
['hi', 'hello', 'hey', 'howdy', 'hello welcome'],
['i dont care', 'any', 'dont care', 'south', 'east', 'west', 
          'north', 'moderate', 'food'
          ,'im looking for', 'priced', 'any', 'expensive', 'restaurant',
          'part of town', 'i need a', 'doesnt matter', 'price range',
          'i need', 'looking for', 'cheap', 'is okay'],
['no im sorry', 'no', 'no id like', 'no dont care',
          'no im looking for'],
['child', 'worthless system', 'noise', 'sil', 'unintelligible',
        'cough'],
['repeat', 'repeat that', 'go back', 'back', 'again please',
          'try this again', 'cant repeat'],
['is there anything else', 'anything else', 'how about',
           'what about'],
['more'],
['phone number', 'address', 'whats the adress',
           'what is the address', 'what is the phone number',
           'whats the phone number', 'post code', 'price range',
           'type of', 'area'],
['start over', 'reset', 'restart', 'start again'],
['thank you good bye', 'thank you goodbye', 'thank you',
            'good bye']]
